...
def render_grid(grid, epoch, save_dir="checkpoints", ax=None):
...
def train_ppo(
    ...
    disc = None
    disc_path = "checkpoints/discriminator_best.pth"
    ...
    for epoch in range(epochs):
        ...
        if mean_ep_reward > best_reward:
            ...
            torch.save(actor.state_dict(), "checkpoints/actor_best.pth")
            torch.save(critic.state_dict(), "checkpoints/critic_best.pth")
    ...
    plt.tight_layout()
    plt.savefig("checkpoints/ppo_training_plot.png")
    plt.close()
    ...
    if first_grid is not None and best_grid is not None:
        ...
        plt.tight_layout()
        plt.savefig("checkpoints/first_vs_best_comparison.png", bbox_inches='tight')
        plt.close()
    ...
    print(f"Saved: checkpoints/actor_best.pth, checkpoints/critic_best.pth")
    print(f"Saved: checkpoints/first_vs_best_comparison.png")
    print(f"Saved: checkpoints/beat_grid_epoch_0.png, checkpoints/beat_grid_epoch_{best_epoch}.png")
